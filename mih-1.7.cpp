...
/**
   ...
   vesion MiHaloes-1.7
   modidied 08 - 03 - 2018 (cgiocoli@gmail.com) read 4 overdensity cats and match according to the virial one
                                                the code works for the HMF project with Trieste
 */
...
int main(){
  std:: string pathvir,path1,path2,path3;
  std:: string sbut;
  ...
  std:: string filvir,fil1,fil2,fil3;
  std:: string ssnap;
  ...
  std:: ifstream ifilvir,ifil1,ifil2,ifil3;
